...
function createIssueListPng(issues) {
  ...
  let CommentText = SVG(`<text transform="translate(302.56 44.92) scale(1.04 1)" style="fill: #7788b2; font-family: AdriannaCondensed-ExtraBold, &apos;Adrianna Condensed&apos;; font-size: 12.85px; font-weight: 700;"><tspan x="0" y="0"></tspan></text>`)
  ...
  for (let i=0; i<issues.length; i++ ) {
    ...
    CommentTextClone.transform({ translateY: ListItemGroupY })
