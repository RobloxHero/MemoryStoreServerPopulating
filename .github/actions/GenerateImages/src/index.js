...
<text id="VersionLabel" text-anchor="middle" x="50%" transform="translate(0 412.59) scale(1.14 1)" style="fill: #fffe2e; font-family: AdriannaCondensed-ExtraBold, &apos;Adrianna Condensed&apos;; font-size: 35.04px; font-weight: 700;">Version 1</text>
</g>`)
let ListHeight = 64
let ListPadding = 5
...
for(let i=0; i<milestones.length; i++) {
  if (!milestones[i].title.includes("Documentation")) {
    ...
    VersionProgress.findOne('#VersionLabel').translateX('50%')
